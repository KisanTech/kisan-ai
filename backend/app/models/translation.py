...
class TranslationRequest(BaseModel):
    ...
    source_language: Optional[str] = Field(None, description="Source language code. If not provided, auto-detect.")
...
class LanguageDetectionRequest(BaseModel):
    ...
    text: str = Field(..., description="Text to analyze for language detection", min_length=1, max_length=30000)
